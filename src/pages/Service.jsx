        ...
        <div className="w-full h-full bg-Primary overflow-hidden ">
            <section id="service_1" className="bg-White w-full h-full flex flex-row justify-center items-center py-25 gap-20">
                ...
                <div className="w-full sm:w-md gap-5 flex flex-col justify-center">
                    ...
                    <h2 className="text-Secondary text-md md:text-lg bg-Primary w-xs flex justify-center items-center px-4 rounded-full font-bold">รับประกันน้ำหยด 30 วัน</h2>
                </div>
            </section> 
            <Seperator/>
            ...
            <section id="service_3" className="bg-White w-full h-full flex flex-row justify-center items-center py-25 gap-20">
                ...
                <div className="w-full sm:w-md gap-5 flex flex-col justify-center">
                    ...
                    <h2 className="text-Secondary text-md md:text-lg bg-Primary w-xs flex justify-center items-center px-4 rounded-full font-bold">รับประกันน้ำหยด 90 วัน</h2>
                </div>
            </section> 
            <Seperator/>
            <section id="service_4" className="bg-White w-full h-full flex flex-row-reverse justify-center items-center py-25 gap-20">
                ...
                <div className="w-full sm:w-md gap-5 flex flex-col justify-center">
                    ...
                    <h2 className="text-Secondary text-md md:text-lg bg-Primary w-xs flex justify-center items-center px-4 rounded-full font-bold">รับประกันน้ำหยด 180 วัน</h2>
                </div>
            </section> 
        </div>
    </>
